...
namespace MarchingBytes {
	...
	class Pool {
		...
		public Pool(string poolName, GameObject poolObjectPrefab, int initialCount, bool fixedSize,Transform parentTransform) {
		...
		private void CreatePools() {
			foreach (PoolInfo currentPoolInfo in poolInfo) {
				...
				Pool pool = new Pool(currentPoolInfo.poolName, currentPoolInfo.prefab, 
				                     currentPoolInfo.poolSize, currentPoolInfo.fixedSize,currentPoolInfo.parentTransform);
